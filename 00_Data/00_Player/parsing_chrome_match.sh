...
awk 'BEGIN{FS=OFS=","} {if( substr($2,13) == "427619232" ) print "{"$1,"99",$3,$4,$5; else }' $targetFile >> $tmpFile
awk 'BEGIN{FS=OFS=","} {if( substr($2,13) == "427619233" ) print "{"$1,"1",$3,$4,$5; else }' $targetFile >> $tmpFile
awk 'BEGIN{FS=OFS=","} {if( substr($2,13) == "427619238" ) print "{"$1,"6",$3,$4,$5; else }' $targetFile >> $tmpFile
awk 'BEGIN{FS=OFS=","} {if( substr($2,13) == "427619235" ) print "{"$1,"3",$3,$4,$5; else }' $targetFile >> $tmpFile
awk 'BEGIN{FS=OFS=","} {if( substr($2,13) == "427619239" ) print "{"$1,"7",$3,$4,$5; else }' $targetFile >> $tmpFile
awk 'BEGIN{FS=OFS=","} {if( substr($2,13) == "427619240" ) print "{"$1,"8",$3,$4,$5; else }' $targetFile >> $tmpFile
awk 'BEGIN{FS=OFS=","} {if( substr($2,13) == "427619245" ) print "{"$1,"13",$3,$4,$5; else }' $targetFile >> $tmpFile
awk 'BEGIN{FS=OFS=","} {if( substr($2,13) == "427619244" ) print "{"$1,"12",$3,$4,$5; else }' $targetFile >> $tmpFile
awk 'BEGIN{FS=OFS=","} {if( substr($2,13) == "427619249" ) print "{"$1,"17",$3,$4,$5; else }' $targetFile >> $tmpFile
awk 'BEGIN{FS=OFS=","} {if( substr($2,13) == "427619241" ) print "{"$1,"9",$3,$4,$5; else }' $targetFile >> $tmpFile
awk 'BEGIN{FS=OFS=","} {if( substr($2,13) == "425734621" ) print "{"$1,"26",$3,$4,$5; else }' $targetFile >> $tmpFile
awk 'BEGIN{FS=OFS=","} {if( substr($2,13) == "428125893" ) print "{"$1,"23",$3,$4,$5; else }' $targetFile >> $tmpFile
awk 'BEGIN{FS=OFS=","} {if( substr($2,13) == "427619242" ) print "{"$1,"10",$3,$4,$5; else }' $targetFile >> $tmpFile
awk 'BEGIN{FS=OFS=","} {if( substr($2,13) == "427619248" ) print "{"$1,"16",$3,$4,$5; else }' $targetFile >> $tmpFile
awk 'BEGIN{FS=OFS=","} {if( substr($2,13) == "427619250" ) print "{"$1,"18",$3,$4,$5; else }' $targetFile >> $tmpFile
awk 'BEGIN{FS=OFS=","} {if( substr($2,13) == "428709461" ) print "{"$1,"2",$3,$4,$5; else }' $targetFile >> $tmpFile
awk 'BEGIN{FS=OFS=","} {if( substr($2,13) == "425173438" ) print "{"$1,"24",$3,$4,$5; else }' $targetFile >> $tmpFile
mv $tmpFile $targetFile
